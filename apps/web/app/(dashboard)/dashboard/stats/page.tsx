...
const STATUS_COLORS: Record<string, string> = {
  active: '#22c55e', premium: '#a855f7', in_progress: '#eab308', hold: '#ef4444', contracted: '#3b82f6', closed: '#6b7280',
};

const STATUS_LABELS_LISTING: Record<string, string> = {
  active: '활성', premium: '우수', in_progress: '진행 중', hold: '보류', contracted: '계약', closed: '종료',
};
